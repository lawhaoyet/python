...
async def on_ready():
    await client.change_presence(status=discord.Status.online,
                                 activity=discord.Game('cli help'))
    print('connecting to we server...')
    print('downloading web server...')
    print('breacking to we server...')
    print('connected to discord')
    print('connected to web server')
    print('hacking discord server system...')
    print('hacked!')
...
token = os.environ.get("ODkwNDIxNjU4Nzk0NDYzMjY0.YUvjyg.H__7f8HCPRmANjDT2jx2uI4N_vA")
